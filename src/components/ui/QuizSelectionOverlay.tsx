...
import type { QuizQuestion, QuizResult, LocalQuizResult } from "../../types/selectionNaturelleTypes"
import {
  Trophy,
  Star,
  ThumbsUp,
...
export default function QuizSelectionOverlay({
  ...
  return (
    <div
      ...
      aria-modal="true"
      role="dialog"
      aria-labelledby="quiz-selection-title"
    >
      <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto pointer-events-auto border-2 border-green-500">
        ...
        <div className="p-6 border-b border-gray-200 relative">
          <h2 id="quiz-selection-title" className="text-2xl font-bold text-gray-800 flex items-center justify-center gap-2">
