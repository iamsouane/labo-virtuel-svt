...
export default function QuizEnergie({
  questions,
  currentQuestion,
  selectedAnswer,
  onAnswerSelect,
      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 border-b border-gray-200">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-2xl font-bold text-gray-800">🧠 Quiz Énergie</h2>
...
function QuizResults({
  ...
  const getScoreMessage = (percentage: number) => {
    if (percentage >= 90) return "🏆 Excellent ! Vous maîtrisez parfaitement les transformations d'énergie !"
    if (percentage >= 80) return "🌟 Très bien ! Vous avez de bonnes connaissances en énergie."
    if (percentage >= 60) return "👍 Pas mal ! Quelques révisions seraient utiles."
    if (percentage >= 40) return "📚 Il faut réviser les bases des transformations d'énergie."
