...
export default function HealthEffects({ aqiStatus }: HealthEffectsProps) {
  return (
    <div className="bg-light p-6 rounded-xl shadow-lg border border-accent flex-1">
      <h3 className="flex items-center gap-2 text-primary font-bold text-xl mb-6">
        <FlaskConical size={24} />
        Effets sur la Santé et l'Environnement
      </h3>

      <section className="mb-6">
        <h4 className="flex items-center gap-2 font-semibold text-dark mb-3">
      ...
      <section>
        ...
        <ul className="space-y-2 text-sm text-dark/70 list-disc list-inside">
